...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_CHECKOUT_URL:
      process.env.NEXT_PUBLIC_CHECKOUT_URL || process.env.VITE_CHECKOUT_URL,
    NEXT_PUBLIC_ZAPIER_ORDER_WEBHOOK_URL:
      process.env.NEXT_PUBLIC_ZAPIER_ORDER_WEBHOOK_URL || process.env.VITE_ZAPIER_ORDER_WEBHOOK_URL,
  },
};
